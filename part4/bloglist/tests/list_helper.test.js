...
describe("total likes", () => {
  ...
  test("handles blog posts with missing likes property", () => {
    const blogs = [
      {
        _id: "5a422aa71b54a676234d17f8",
        title: "Go To Statement Considered Harmful",
...
describe("most blogs", () => {
  ...
  test("when list has multiple authors, returns the one with the most blogs", () => {
  ...
  test("when list has only one author, returns that author", () => {
    ...
    const result = listHelper.mostBlogs(singleAuthorBlogs);
    const expected = {
      author: "Michael Chan",
      blogs: 1,
    };
...
describe("most likes", () => {
  ...
  test("when list has multiple authors, returns the one with the most likes", () => {
  ...
  test("when list has only one author, returns that author", () => {
    const singleAuthorBlogs = [blogs[0]];
    const result = listHelper.mostLikes(singleAuthorBlogs);
    const expected = {
      author: "Michael Chan",
      likes: 7,
    };
